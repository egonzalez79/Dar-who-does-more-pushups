...
In this study, line and skill players do pushups for 2 minutes. We will look at the results by graphing in a ggplot. Then we will see the numerical results.

# Results
<!--You have both graphical and numerical methods, so you will have both graphical and numerical results to consider.!-->
According to the results in my graph we can see that skill players do more pushups than line players. 
...
In conclution, we find that the average skill player does 57% more pushups than the averge line player.
